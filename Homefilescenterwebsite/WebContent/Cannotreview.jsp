  ...
  <head>
   ...
   <!--=============================================== 
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Cannot find the product</title>
    ...
    <section id="errorpage">
      <div class="container" style="background-color:#D5F5E3  ;">
        ...
        <br><br><br><br><br><br><br><br><br>
             <h3>PLEASE PROVIDE THE PRODUCT NAME WHICH EXISTS</h3>
             <h3>SORRY :(</h3>
             <h3><s:property value="#session.context" />, the name of the product/category requested by you for giving reviews to it either do not exist or you may have miss-spelled it.You could give reviews to only those products which are already added by someone or by yourself.Other than these,you cannot give reviews to random products. </h3>
             <p class="wow fadeInLeftBig animated" style="visibility: visible; animation-name: fadeInLeftBig;">Please, try again from <a href="Givereviews.jsp">HERE</a></p>
           </div>
      </div>
    </section>
    <!--=========== END GALLERY SECTION ================-->
