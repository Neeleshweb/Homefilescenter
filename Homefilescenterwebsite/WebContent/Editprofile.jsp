...
<html lang="en">
  ...
  <body >
    ...
    <section id="imgBanner">
      <h2>EDIT YOUR PROFILE/ACCOUNT</h2>
    </section>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">KEEP YOUR PROFILE UPDATED</h2>
              <span></span> 
              <p>We care for your presence, so please stay updated on your account, since we need to display your info to all the other users, so provide or edit appropriately.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Editprofile" method="post">
                <input type="email" class="wp-form-control wpcf7-text" name=emailid placeholder="Enter your emailid">
                 <input type="password" class="wp-form-control wpcf7-text" name=password placeholder="enter your password">
                  <input type="text" class="wp-form-control wpcf7-text" name=fullname placeholder="Enter your full name">
                   <input type="text" class="wp-form-control wpcf7-text" name=address placeholder="Enter your current address">
                <input type="mail" class="wp-form-control wpcf7-email" name=country placeholder="Enter your country name">          
              
                <input type="submit" value="UPDATE PROFILE" class="wpcf7-submit">
              </form>
           </div>
         </div>
