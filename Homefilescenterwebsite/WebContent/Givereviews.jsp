  ...
  <head>
   ...
   <!--=============================================== 
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Specify the product/category</title>
    ...
    <section id="errorpage">
      <div class="container" style="background-color:#D5F5E3  ;">
        <div class="error_page_content">
             ...
             <br>
             <br>
             <h3>SPECIFY THE NAME OF THE PRODUCT/CATEGORY TO WHICH YOU WANT TO GIVE REVIEWS</h3>
             
             <form action="givereview" method="post"><ul>
             <li><h4 class="wow fadeInLeftBig animated" style="visibility: visible; animation-name: fadeInLeftBig;">Please, continue after specifying the name of the product to which you want to give review
             <input type=text name="productname" placeholder="enter the name of the category">
             <input type="submit" value="GIVE REVIEWS">
