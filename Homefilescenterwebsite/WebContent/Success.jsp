       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Congratulations "<s:property value="#session.context4"/>",your category/product "<s:property value="Category"/>" is added.</h2>
              <span></span> 
              <p>Now you should give your reviews to this product you have added just now.The review which you give will be posted to your home wall and everyone can see it,like it and also comment on it.So keep the reviews genuine so that users get to know the exact quality of product.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Givereviews.jsp" method="post">
               <fieldset>
               <legend>Your added category/product details</legend>
                <label>CATEGORY NAME/PRODUCT 1 NAME:</label><s:property value="Category"/><br><br><br>
                <label>SUB-CATEGORY 1 NAME/PRODUCT 2 NAME:</label><s:property value="subcategory1"/><br><br>
                <label>SUB-CATEGORY 2 NAME/PRODUCT 3 NAME:</label><s:property value="subcategory2"/><br><br>
                <label>SUB-CATEGORY 3 NAME/PRODUCT 4 NAME:</label><s:property value="subcategory3"/><br><br>
                <label>SUB-CATEGORY 4 NAME/PRODUCT 5 NAME:</label><s:property value="subcategory4"/><br><br>
                
                  <label>SUB-CATEGORY 5 NAME/PRODUCT 5 NAME:</label><s:property value="subcategory5"/><br><br>
                  <center><input type="submit" value="PROCEED TO GIVE REVIEW"></center>
              </fieldset>
