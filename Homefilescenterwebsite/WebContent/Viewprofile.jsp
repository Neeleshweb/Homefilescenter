      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> <div class="container">
          <div class="navbar-header">
            ...
            <!-- LOGO -->
            <!-- TEXT BASED LOGO -->
            <a class="navbar-brand" href="Welcome.jsp" target="_blank">HomefileS<span>CenteR</span></a>            
            <!-- IMG BASED LOGO  -->
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
              <li><a href="Welcome.jsp" target="_blank">Home</a>            
            <!-- IMG BASED LOGO  -->
             <!-- <a class="navbar-brand" href="index.html"><img src="img/logo.png" alt="logo"></a>  -->           
                  </li>
              <li class="active"><a href="Addcat.jsp" target="_blank">Add my category/product</a></li>
              <li><a href="Statistics.jsp" target="_blank">Leaderboard and ranks</a></li>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two"> "<s:property value="#session.context4"/>", your profile.</h2>
              <span></span> 
              <p>Here you can view your most updated profile info.You can edit your profile from edit profile link at welcome page.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Givereviews.jsp" method="post">
               <fieldset>
               <legend><b>Your profile details</b></legend>
                
                <label>YOUR EMAILID  :</label><s:property value="#session.context" /><br><br>
                <label>YOUR PASSWORD :</label><s:property value="#session.context3" /><br><br>
                <label>YOUR FULLNAME :</label><s:property value="#session.context4" /><br><br>
                <label>YOUR ADDRESS  :</label><s:property value="#session.context5" /><br><br>
                <label>YOUR COUNTRY  :</label><s:property value="#session.context6" /><br><br>
