...
<html lang="en">
  ...
  ====================================================-->
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Please provide your category/product details</title>
  ...
  <body >
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> <div class="container">
          <div class="navbar-header">
            ...
            <!-- LOGO -->
            <!-- TEXT BASED LOGO -->
            <a class="navbar-brand" href="Welcome.jsp">HomefileS<span>CenteR</span></a>            
            <!-- IMG BASED LOGO  -->
    ...
    <section id="imgBanner">
      <h2>ADD THE CATEGORY/PRODUCT</h2>
    </section>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">PLEASE PROVIDE THE DETAILS OF CATEGORY/PRODUCT</h2>
              <span></span> 
              <p>Congrats,you have passed the test successfully and now you need to provide the name of the category/product alongwith the sub-categories of it.You should add minimum of 2 sub-categories to a category to proceed.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Addcategory" method="post">
               
                <input type="text" class="wp-form-control wpcf7-text" name=Category placeholder="ENTER THE NAME OF CATEGORY/PRODUCT">
                 <input type="text" class="wp-form-control wpcf7-text" name=subcategory1 placeholder="enter first sub-category/sub product type">
                  <input type="text" class="wp-form-control wpcf7-text" name=subcategory2 placeholder="enter second sub-category/sub product type">
                   <input type="text" class="wp-form-control wpcf7-text" name=subcategory3 placeholder="enter third sub-category/sub product type">
                <input type="text" class="wp-form-control wpcf7-email" name=subcategory4 placeholder="enter fourth sub-category/sub product type">
                
                         <input type="text" class="wp-form-control wpcf7-email" name=subcategory5 placeholder="enter fifth sub-category/sub product type"> 
                         <input type="email" class="wp-form-control wpcf7-text" name=email placeholder="Enter your emailid please"> 
