    ...
    <section id="errorpage">
      <div class="container" style="background-color:#D5F5E3  ;" >
        ...
        <br><br><br><br><br><br><br><br><br>
             <h3>THIS IS NOT YOUR EMAILID</h3>
             <h3>SORRY :(</h3>
             <h3>THE EMAILID YOU ENTERED DOES NOT MATCHES WITH YOUR REGISTERED EMAILID.PLEASE PROVIDE THAT EMAILID,BY WHICH YOU HAVE MADE YOUR ACCOUNT ON HOMEFILESCENTER,THAT IS BY WHICH YOU ARE CURRENTLY LOGGED IN.</h3>
             <p class="wow fadeInLeftBig animated" style="visibility: visible; animation-name: fadeInLeftBig;">Please, try again from <a href="Categoryform.jsp">HERE</a></p>
           </div>
      </div>
    </section>
    <!--=========== END GALLERY SECTION ================-->
