    ...
    <section id="errorpage">
      <div class="container" style="background-color:#D5F5E3  ;">
        ...
        <br><br><br><br><br><br><br><br><br>
             <h3>YOUR EMAILID OR PASSWORD IS NOT VALID</h3>
             <h3>SORRY :(</h3>
             <h3>PLEASE PROVIDE VALID DETAILS TO CONTINUE</h3>
             <p class="wow fadeInLeftBig animated" style="visibility: visible; animation-name: fadeInLeftBig;">Please, try again from <a href="Login.jsp">HERE</a></p>
           </div>
      </div>
    </section>
    <!--=========== END GALLERY SECTION ================-->
