...
<html lang="en">
  ...
  ====================================================-->
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>REGISTER WITH US TO GET BENEFITS</title>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">BENEFITS OF REGISTRATION</h2>
              <span></span> 
              <p>Make your account and enjoy the world's first dynamic ranking platform.Give reviews to products rated by different people,comment on reviews,add your own category,take a exciting test to check your skills and much more.Just one step,register and proceed.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Signup" method="post">
