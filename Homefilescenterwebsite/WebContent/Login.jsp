       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">LOGIN TO CONTINUE</h2>
              <span></span> 
              <p>If you have successfully created your account then please login to continue, otherwise sign-up and then come-back here again to login.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form" action="Login" method="post" target="_blank">
