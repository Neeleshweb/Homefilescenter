            ...
            <div class="courseArchive_content">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="Login.jsp" class="blog_img" target="_blank">
                        <img alt="img" src="img/rev1.png">
                      </a>
                    </div>
                    <h2 class="blog_title"> Sharing your reviews about a product after using it.</h2>
                    <div class="blog_commentbox">
                      <p><i class="fa fa-user"></i>Name of the reviewer</p>
                      <p><i class="fa fa-calendar"></i>Date of the review made</p>
                      
                    </div>
                    <b><p class="blog_summary">Here the users can give reviews to products and other users can regulate their purchase according to the review posted</p></b>
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="Signup.jsp" class="blog_img" target="_blank">
                        <img alt="img" src="img/regis1.png">
                      </a>
                    </div>
                    <h2 class="blog_title"> Make your account,get free subscriptions and much more</h2>
                    
                    <b><p class="blog_summary">Make your account,give reviews to products added by our customers or add your own product to be reviewed.Get free subscriptions of various websites ,if your rank is under 500,which depends upon your test score,which further depends upon your understanding and experience of using any product.</p></b>
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="Signup.jsp" class="blog_img" target="_blank">
                        <img alt="img" src="img/revcomment.png">
                      </a>
                    </div>
                    <h2 class="blog_title"> Give reviews to products,comment etc</h2>
                    
                    <b><p class="blog_summary">Give reviews to products after using it which will be supported by or criticized by different users all over the globe by liking it or commenting on on your post.</p></b>
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="Login.jsp" class="blog_img" target="_blank">
                        <img alt="img" src="img/test.png">
                      </a>
                    </div>
                    <h2 class="blog_title"> An online test </h2>
                  
                    <b><p class="blog_summary">This test lets you know whether you are a potential customer or not.If you are,then you will make purchase reasonably and if you are not,then you might be wasting your money.</p></b>
