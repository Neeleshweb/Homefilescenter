...
<html lang="en">
  ...
  ====================================================-->
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Reach us anytime anywhere 24/7</title>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Join our community of developers</h2>
              <span></span> 
              <p>We require potential candidates who have unquenchable thirst for learning and implementing new concepts. If you are interested to have a bright carrier with us, drop us an email at the given email id. We will surely contact you. We work on cloud environment, J2EE, Googple deployment, Java API Development , Spring and Struts framework etc. Plenty of opportunities, so join this and ameliorate your skills.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <h3>REACH US VIA EMAIL 24*7 AND SHARE YOUR RESUME IN THE MAIL .</h3>
             <div class="address_group">
               <p>Jr 52,Varanasi ,India</p>
               <p>Phone: +918130033890</p>
               <p>Email:Neelesh.Homefilescenter14@gmail.com</p>
             </div>
           </div>
         </div>
             ...
             <div class="address_group">
              <ul class="footer_social">
                <li><a href="https://www.facebook.com/neeleshweb/?ref=aymt_homepage_panel" target="_blank" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://twitter.com/1234stannis" target="_blank" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Twitter"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://plus.google.com/u/0/105840078908653538244" target="_blank" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Google+"><i class="fa fa-google-plus"></i></a></li>
                <li><a href="https://www.linkedin.com/groups/7051038" target="_blank" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
                <li><a href="https://www.youtube.com/dashboard?o=U" target="_blank" class="soc_tooltip" title="" data-placement="top" data-toggle="tooltip" data-original-title="Youtube"><i class="fa fa-youtube"></i></a></li>
                </ul>
             </div>
           </div>
         </div>
